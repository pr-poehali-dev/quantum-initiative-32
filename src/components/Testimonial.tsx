  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Колледж дал мне не просто диплом, а настоящую профессию. Уже на втором курсе я проходила стажировку и получила оффер до выпуска. Это лучшее решение в моей жизни.
        </blockquote>
        ...
        >
          ...
          <p className="text-sm text-primary-foreground/60 mt-1">Выпускница, направление «Информационные технологии»</p>
        </div>
      </div>
    </section>
  )
