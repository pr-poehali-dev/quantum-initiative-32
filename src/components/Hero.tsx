  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Знания,
          <span className="block text-sage">которые открывают путь</span>
        </h1>
        ...
        >
          Мы готовим специалистов, которые востребованы на рынке труда. Практическое образование, опытные преподаватели и среда, где раскрывается каждый студент.
        </p>
